...
<style>
    #display-img{
        width: 100%;
        height: 60vh; /* Giữ chiều cao cố định để layout không bị vỡ */
        background: #ffffff; /* Đổi nền đen thành nền trắng */
        border: 1px solid #dee2e6; /* Thêm viền mỏng cho đẹp */
    }
    #display-img>img{
        height: 100%;
        width: 100%;
        object-fit: cover; /* Đây là thay đổi quan trọng */
    }
</style>
<section class="py-5">
