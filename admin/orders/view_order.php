    ...
    <div class="card-body">
        <div class="conitaner-fluid">
            ...
            <table class="table-striped table table-bordered" id="list">
                ...
                <tbody>
                    <?php 
                        $olist = $conn->query("SELECT o.*,p.name,b.name as bname FROM order_list o left join products p on o.product_id = p.id inner join brands b on p.brand_id = b.id where o.order_id = '{$id}' ");
        ...
        <div class="row">
            <div class="col-6">
                <p>Payment Method: <?php echo ucwords($payment_method) ?></p>
            ...
            <div class="col-6 row row-cols-2">
                ...
                <div class="col">
                    ...
                    <?php if($paid == 0): ?>
                    <button type="button" id="mark_paid" class="btn btn-sm btn-flat btn-light border">Paid</button>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
...
<script>
    ...
    $(function(){
        $('#mark_paid').click(function(){
			_conf("Are you sure to mark this order as paid?","pay_order",['<?= $id ?>'])
		})
